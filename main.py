...
menu = st.sidebar.radio("MENU", ["📊 Dashboard", "🚀 Entregar EPI", "👥 Funcionários", "📦 Catálogo", "📑 Relatórios", "⚙️ Configurações"])

# --- DASHBOARD (REENVIAR LINK) ---
if menu == "📊 Dashboard":
...
# --- CENTRAL DE FUNCIONÁRIOS (COM OPÇÃO DE DELETAR) ---
    ...
    with t_u:
        ...
        st.info("💡 Para DELETAR: Selecione a linha, aperte 'Delete' no teclado e clique em Salvar.")
        ed = st.data_editor(df_f, num_rows="dynamic", use_container_width=True) # DELETAR ATIVO AQUI
